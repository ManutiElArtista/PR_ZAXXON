...
public class MovimientoYRapidez : MonoBehaviour
{
    ...
    void Moove()
    {
        ...
        {
            transform.Translate(Vector3.right * despX * Time.deltaTime * despSpeed, Space.World);
        }     
        ...
        {
            transform.Translate(Vector3.up * despY * Time.deltaTime * despSpeed, Space.World); // El Space.World se utiliza para que a la hora de rotar, rote de manera normal y se mueva hacia arriba y no coja los valores del transform.
        }
    }
